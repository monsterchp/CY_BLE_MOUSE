...
{
    0x001Cu,    /* Handle of the DIS service */
    {
        0x001Eu, /* Handle of the Manufacturer Name String characteristic */ 
        ...
        0x0020u, /* Handle of the Firmware Revision String characteristic */ 
