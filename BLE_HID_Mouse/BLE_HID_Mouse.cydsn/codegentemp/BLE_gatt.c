    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x86u] = {
    /* Device Name */
...
*/
0x09u, 0x01u, /* USAGE              */
0xA1u, 0x00u, /* COLLECTION         */
0x85u, 0x01u, /* REPORT_ID         
*/
0x05u, 0x09u, /* USAGE_PAGE         */
0x19u, 0x01u, /* USAGE_MINIMUM      */
0x29u, 0x03u, /* USAGE_MAXIMUM     
*/
0x15u, 0x00u, /* LOGICAL_MINIMUM    */
0x25u, 0x01u, /* LOGICAL_MAXIMUM    */
0x95u, 0x03u, /* REPORT_COUNT      
*/
0x75u, 0x01u, /* REPORT_SIZE        */
0x81u, 0x02u, /* INPUT              */
0x95u, 0x01u, /* REPORT_COUNT      
*/
0x75u, 0x05u, /* REPORT_SIZE        */
0x81u, 0x03u, /* INPUT              */
0x05u, 0x01u, /* USAGE_PAGE        
*/
0x09u, 0x30u, /* USAGE              */
0x09u, 0x31u, /* USAGE              */
0x15u, 0x81u, /* LOGICAL_MINIMUM   
*/
0x25u, 0x7Fu, /* LOGICAL_MAXIMUM    */
0x75u, 0x08u, /* REPORT_SIZE        */
0x95u, 0x02u, /* REPORT_COUNT      
*/
0x81u, 0x06u, /* INPUT              */
...
(uint8)'r', 
    ...
    /* PnP ID */
    0x02u, 0xB4u, 0x04u, 0x09u, 0x00u, 0x01u, 0x00u, 
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0003u, (void *)&cyBle_attValues[23] }, /* Report In */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* Client Characteristic Configuration */
    { 0x0002u, (void *)&cyBle_attValues[26] }, /* Report Reference */
    { 0x0034u, (void *)&cyBle_attValues[28] }, /* Report Map */
    { 0x0004u, (void *)&cyBle_attValues[80] }, /* HID Information */
    { 0x0001u, (void *)&cyBle_attValues[84] }, /* HID Control Point */
    { 0x0001u, (void *)&cyBle_attValues[85] }, /* Protocol Mode */
    { 0x0003u, (void *)&cyBle_attValues[86] }, /* Boot Mouse Input Report */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[4] }, /* Client Characteristic Configuration */
    { 0x0015u, (void *)&cyBle_attValues[89] }, /* Manufacturer Name String */
    { 0x0004u, (void *)&cyBle_attValues[110] }, /* Firmware Revision String */
    { 0x0007u, (void *)&cyBle_attValues[114] }, /* PnP ID */
    { 0x0001u, (void *)&cyBle_attValues[121] }, /* Battery Level */
    ...
    { 0x0004u, (void *)&cyBle_attValues[129] }, /* Scan Interval Window */
    { 0x0001u, (void *)&cyBle_attValues[133] }, /* Scan Refresh */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x2Du] = {
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x00000001u /*           */, 0x001Bu, {{0x1812u, NULL}}                           },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00001A01u /* rd,wr,ntf */, 0x0010u, {{0x2A4Du, NULL}}                           },
    { 0x000Eu, 0x2A4Du /* Report In                           */, 0x00001A0Fu /* rd,wr,ntf */, 0x0010u, {{0x0003u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr     */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x0010u, 0x2908u /* Report Reference                    */, 0x00000201u /* rd        */, 0x0010u, {{0x0002u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd        */, 0x0012u, {{0x2A4Bu, NULL}}                           },
    { 0x0012u, 0x2A4Bu /* Report Map                          */, 0x00000209u /* rd        */, 0x0012u, {{0x0034u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd        */, 0x0014u, {{0x2A4Au, NULL}}                           },
    { 0x0014u, 0x2A4Au /* HID Information                     */, 0x00000209u /* rd        */, 0x0014u, {{0x0004u, (void *)&cyBle_attValuesLen[9]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00000401u /* wwr       */, 0x0016u, {{0x2A4Cu, NULL}}                           },
    { 0x0016u, 0x2A4Cu /* HID Control Point                   */, 0x0000040Au /* wwr       */, 0x0016u, {{0x0001u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0017u, 0x2803u /* Characteristic                      */, 0x00000601u /* rd,wwr    */, 0x0018u, {{0x2A4Eu, NULL}}                           },
    { 0x0018u, 0x2A4Eu /* Protocol Mode                       */, 0x0000060Fu /* rd,wwr    */, 0x0018u, {{0x0001u, (void *)&cyBle_attValuesLen[11]}} },
    { 0x0019u, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf    */, 0x001Bu, {{0x2A33u, NULL}}                           },
    { 0x001Au, 0x2A33u /* Boot Mouse Input Report             */, 0x00001209u /* rd,ntf    */, 0x001Bu, {{0x0003u, (void *)&cyBle_attValuesLen[12]}} },
    { 0x001Bu, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr     */, 0x001Bu, {{0x0002u, (void *)&cyBle_attValuesLen[13]}} },
    { 0x001Cu, 0x2800u /* Primary service                     */, 0x00000001u /*           */, 0x0022u, {{0x180Au, NULL}}                           },
    { 0x001Du, 0x2803u /* Characteristic                      */, 0x00000201u /* rd        */, 0x001Eu, {{0x2A29u, NULL}}                           },
    { 0x001Eu, 0x2A29u /* Manufacturer Name String            */, 0x00000209u /* rd        */, 0x001Eu, {{0x0015u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x001Fu, 0x2803u /* Characteristic                      */, 0x00000201u /* rd        */, 0x0020u, {{0x2A26u, NULL}}                           },
    { 0x0020u, 0x2A26u /* Firmware Revision String            */, 0x00000209u /* rd        */, 0x0020u, {{0x0004u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0021u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd        */, 0x0022u, {{0x2A50u, NULL}}                           },
    { 0x0022u, 0x2A50u /* PnP ID                              */, 0x00000209u /* rd        */, 0x0022u, {{0x0007u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0023u, 0x2800u /* Primary service                     */, 0x00000001u /*           */, 0x0027u, {{0x180Fu, NULL}}                           },
    { 0x0024u, 0x2803u /* Characteristic                      */, 0x00001201u /* rd,ntf    */, 0x0027u, {{0x2A19u, NULL}}                           },
    { 0x0025u, 0x2A19u /* Battery Level                       */, 0x00001209u /* rd,ntf    */, 0x0027u, {{0x0001u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x0026u, 0x2904u /* Characteristic Presentation Format  */, 0x00000201u /* rd        */, 0x0026u, {{0x0007u, (void *)&cyBle_attValuesLen[18]}} },
    { 0x0027u, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr     */, 0x0027u, {{0x0002u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x0028u, 0x2800u /* Primary service                     */, 0x00000001u /*           */, 0x002Du, {{0x1813u, NULL}}                           },
    { 0x0029u, 0x2803u /* Characteristic                      */, 0x00000401u /* wwr       */, 0x002Au, {{0x2A4Fu, NULL}}                           },
    { 0x002Au, 0x2A4Fu /* Scan Interval Window                */, 0x0000040Au /* wwr       */, 0x002Au, {{0x0004u, (void *)&cyBle_attValuesLen[20]}} },
    { 0x002Bu, 0x2803u /* Characteristic                      */, 0x00001001u /* ntf       */, 0x002Du, {{0x2A31u, NULL}}                           },
    { 0x002Cu, 0x2A31u /* Scan Refresh                        */, 0x00001000u /* ntf       */, 0x002Du, {{0x0001u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x002Du, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr     */, 0x002Du, {{0x0002u, (void *)&cyBle_attValuesLen[22]}} },
};
