// ======================================================================
// BLE_HID_Mouse.v generated from TopDesign.cysch
// 09/19/2016 at 14:14
...
module top ;
	...
	wire [0:0] tmpOE__Simulation_LED_net;
	wire [0:0] tmpFB_0__Simulation_LED_net;
	wire [0:0] tmpIO_0__Simulation_LED_net;
	wire [0:0] tmpINTERRUPT_0__Simulation_LED_net;
	electrical [0:0] tmpSIOVREF__Simulation_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d0fe4d41-17bb-4a1b-8e56-fab43dac192b"),
		  ...
		  .input_buffer_sel(2'b00))
		Simulation_LED
		 (.oe(tmpOE__Simulation_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Simulation_LED_net[0:0]}),
		  .io({tmpIO_0__Simulation_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Simulation_LED_net),
		  .interrupt({tmpINTERRUPT_0__Simulation_LED_net[0:0]}),
		  .annotation({Net_18}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Simulation_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
